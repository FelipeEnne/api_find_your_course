...
class CoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course" do
    assert_difference('Course.count') do
      post courses_url, params: { course: { description: @course.description, image: @course.image, name: @course.name, owner: @course.owner, starts: @course.starts, value: @course.value } }, as: :json
    end
